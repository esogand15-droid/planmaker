...
**مشاور** — دو راه، هیچ‌کدام اجباری نیست از Shell:

* **از داخل ربات:** مشاور یک‌بار `/start` بزند → شما در «🛠 پنل مدیریت →
  🙋 درخواست‌های دسترسی» او را می‌بینید → «👨‍🏫 تأیید به‌عنوان مشاور».
* **یا مستقیم:** پنل مدیریت → 👥 مدیریت مشاوران → ➕ افزودن مشاور.
* **یا از Shell** (اختیاری):
