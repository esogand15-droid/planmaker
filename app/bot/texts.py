...
ADMIN_NO_ADVISORS = (
    ...
    "با دکمهٔ زیر مشاور جدید اضافه کنید یا از بخش «درخواست‌های دسترسی» "
    "به کسی که ربات را باز کرده نقش مشاور بدهید."
)
ADMIN_ADVISOR_CARD = (
    "👨‍🏫 <b>مشاور: {name}</b>\n\n"
    "وضعیت: {status}\n"
...
ACCESS_PENDING = (
    ...
    "✅ درخواست دسترسی شما برای مدیر ارسال شد.\n"
    "به‌محض تأیید، همین‌جا به شما اطلاع داده می‌شود.\n\n"
    "اگر مشاور دارید، می‌توانید از او لینک دعوت هم بگیرید."
)
ACCESS_PENDING_AGAIN = (
    "⏳ درخواست شما در انتظار بررسی مدیر است.\n\n"
    "به‌محض تأیید، همین‌جا اطلاع داده می‌شود."
)
ACCESS_REJECTED = (
    "⛔️ درخواست دسترسی شما تأیید نشد.\n"
    "در صورت نیاز با پشتیبانی مؤسسه تماس بگیرید."
)
ACCESS_APPROVED_ADVISOR = (
    "🎉 دسترسی شما تأیید شد!\n\n"
    "از این پس به‌عنوان <b>مشاور</b> رتبه لند می‌توانید دانش‌آموزان خود را "
    "اضافه کنید و برایشان برنامه هفتگی بسازید.\n\n"
    "برای شروع /start را بزنید."
)
ACCESS_APPROVED_STUDENT = (
    "🎉 دسترسی شما تأیید شد!\n\n"
    "حساب شما به‌عنوان <b>دانش‌آموز</b> فعال شد.\n"
    "برای دیدن برنامه‌ها /start را بزنید."
)
ADMIN_REQUESTS = (
    "🙋 <b>درخواست‌های دسترسی</b> — {count} در انتظار\n\n"
    "افرادی که ربات را باز کرده‌اند ولی هنوز حسابی ندارند."
)
ADMIN_NO_REQUESTS = (
    "🙋 <b>درخواست‌های دسترسی</b>\n\n"
    "درخواست بررسی‌نشده‌ای وجود ندارد."
)
ADMIN_REQUEST_CARD = (
    "🙋 <b>درخواست دسترسی</b>\n\n"
    "نام: <b>{name}</b>\n"
    ...
    "شناسه تلگرام: <code>{telegram}</code>\n"
    "تعداد مراجعه: {visits}\n"
    "آخرین مراجعه: {last_seen}\n\n"
    "چه نقشی به این شخص داده شود؟"
)
ADMIN_REQUEST_APPROVED = "✅ «{name}» به‌عنوان {role} اضافه شد."
ADMIN_REQUEST_REJECTED = "🚫 درخواست «{name}» رد شد."
ADMIN_ADD_ADVISOR_PROMPT = (
    "➕ <b>افزودن مشاور</b>\n\n"
    "نام و شناسه عددی تلگرام را بفرستید:\n"
    "<code>علی مرادی | 123456789</code>\n\n"
    "<i>شناسه را می‌توان با فرستادن /id به همین ربات دید.</i>"
)
ADMIN_ADVISOR_ADDED = "✅ مشاور «{name}» اضافه شد."
